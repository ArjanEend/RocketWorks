...
namespace RocketWorks.Entities
{
    ...
    public partial struct EntityReference<T> : IRocketable where T : Entity
    {
        public uint creationIndex;
        public int owner;
        ...
        public T Entity
        {
            get {
                if (entity != null || pool == null)
                    return entity;
                return entity =  pool.GetEntity(creationIndex, owner) as T;
            }
        }
        ...
        public static implicit operator T(EntityReference<T> ent)
        {
            return ent.Entity;
        }

        public static implicit operator EntityReference<T>(T ent)
        { 
            return new EntityReference<T>(ent);
        }

        public static bool operator ==(EntityReference<T> reference, T ent)
        {
            if (ent == null)
                return reference.entity == ent || !reference.entity.Alive;
            return reference.creationIndex == ent.CreationIndex;
